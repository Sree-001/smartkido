...
@Component({
  selector: 'app-mult-pract',
  templateUrl: './mult-pract.component.html',
  styleUrls: ['./mult-pract.component.css']
})
export class MultPractComponent implements OnInit {
  selectedLevel;
  numberOne;
  numberTwo;
  oldNumberOne;
 ...
 reset(){
  ...
  if(levelKey === 'easy'){
   ...
   this.numberTwo = this.generateRandomNo(20);
   ...
   this.oldNumberTwo = this.numberTwo;
    ...
    this.numberTwo = this.generateRandomNo(100);
    this.oldNumberOne = this.numberOne;
    this.oldNumberTwo = this.numberTwo;

  }else{
    this.numberOne = this.generateRandomNo(1000);
    this.numberTwo = this.generateRandomNo(1000);
    this.oldNumberOne = this.numberOne;
    this.oldNumberTwo = this.numberTwo;
  }
